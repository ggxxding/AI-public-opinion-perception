...
<script>
  import * as  echarts from "echarts";
    export default {
        name: "sentiment.vue",
      props: ["sentiment","active_keyword","active_timescope"],
      data() {
        return {
          chart: null,
        };
      ...
      methods:{
          figureConfigure(){
            ...
            for (var i = 0; i < this.sentiment[this.active_keyword][this.active_timescope].length; i++) {
              if (this.sentiment[this.active_keyword][this.active_timescope][i].name=='pos'){
                data.push(
                  {
                    value: this.sentiment[this.active_keyword][this.active_timescope][i].value,
                    name: '积极',
                    itemStyle: {
                      normal: {
                        borderWidth: 5,
              ...
              }else if(this.sentiment[this.active_keyword][this.active_timescope][i].name=='neg'){
                data.push(
                  {
                    value: this.sentiment[this.active_keyword][this.active_timescope][i].value,
                    name: '消极',
